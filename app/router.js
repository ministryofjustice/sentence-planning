...
module.exports = app => {
  ...
  app.get(`${activePlanRoute}/print-full`, (req, res) => res.render('app/error', { error: 'Functionality still to be developed' }))
  app.get(`${activePlanRoute}/print-simple`, (req, res) => res.render('app/error', { error: 'Functionality still to be developed' }))
  app.get(`${activePlanRoute}/end-plan`, (req, res) => res.render('app/error', { error: 'Functionality still to be developed' }))
  app.get(`${activePlanRoute}/sentence-board-review`, (req, res) => res.render('app/error', { error: 'Functionality still to be developed' }))
  app.get(`${activePlanRoute}/contact-arrangements`, (req, res) => res.render('app/error', { error: 'Functionality still to be developed' }))
